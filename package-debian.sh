...
xray_url_for_rid() {
  ...
  case "$rid" in
    linux-x64)   echo "https://github.com/patterniha/Xray-core/releases/download/v${ver}/Xray-linux-64.zip" ;;
    linux-arm64) echo "https://github.com/patterniha/Xray-core/releases/download/v${ver}/Xray-linux-arm64-v8a.zip" ;;
    *)           return 1 ;;
  esac
}
